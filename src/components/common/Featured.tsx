...
const Featured = () => {
  ...
  return (
    <div id='projects' className='w-full rounded-tl-3xl rounded-tr-3xl py-20 px-20 bg-zinc-900 relative is-inview'>
      ...
      <div className='w-full border-b-[1px] border-zinc-700 pb-20 flex items-center gap-6  '>
        <h1 className='text-7xl font tracking-wide font-[FoundersGrotesk] uppercase'>Feature projects</h1>
        
        {/* Segment Control */}
        <div className='flex justify-center mt-3'>
          <div className='relative inline-flex bg-zinc-800 rounded-full p-1.5 gap-2'>
            <motion.div
              className='absolute top-1.5 bg-[#CDEA68] rounded-full'
              animate={{
                x: activeTab === 'design-project' ? 0 : 182,
              }}
              style={{ 
            ...
            <button
              ...
              className={`relative z-10 w-44 py-3 rounded-full font-[FoundersGrotesk] text-3xl font-medium transition-colors duration-300 ${
      ...
      <div>
        ...
        <AnimatePresence mode='wait'>
          <motion.div
            ...
            className='cards w-full mt-10 grid grid-cols-2 gap-[30px]'
          >
              ...
              return (
                ...
                >
                  ...
                  <AnimatePresence>
                    {hoveredId === item.id && (
                      <motion.h3
                        className={`absolute w-ful h-[auto] justify-center flex flex-nowrap ${
